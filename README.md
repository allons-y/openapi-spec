# OpenAPI v3 object model [![Build Status](https://github.com/go-openapi/spec/actions/workflows/go-test.yml/badge.svg)](https://github.com/go-openapi/spec/actions?query=workflow%3A"go+test") [![codecov](https://codecov.io/gh/go-openapi/spec/branch/master/graph/badge.svg)](https://codecov.io/gh/go-openapi/spec)
...
> 1. This package knows how to marshal and unmarshal OpenAPI v3 specifications into a golang object model
...
> **Yes!**
> This package now supports OpenAPI v3.x (specifically OpenAPI 3.0+).
> The codebase has been migrated from OpenAPI v2 (Swagger 2.0) to OpenAPI v3.
>
> Key changes in v3:
...
>
> For migration guidance, see [MIGRATION_V3.md](./MIGRATION_V3.md)
